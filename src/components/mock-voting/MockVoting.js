...
const ElectionStatus = styled.div`
  ...
  color: ${props => props.active ? '#0073e6' : '#999'};
...
const MockVoting = () => {
    ...
    const handleVoteClick = (electionId) => {
        navigate(`/virtual-vote/${electionId}`);
    };
                    ...
                    <>
                        <InfoSection>
                            ...
                            <InfoText>
                                ...
                                실제 선거와 동일한 환경에서 투표를 연습해보고, 다른 유권자들의 선택 경향도 익명으로 확인해볼 수 있습니다.(이 멘트 괜찮나)
                            </InfoText>
                            <InfoText>
                                ※ 가상투표 결과는 실제 선거와 무관하며, 투표 결과는 익명으로 통계 처리됩니다.
                            </InfoText>
                        </InfoSection>
